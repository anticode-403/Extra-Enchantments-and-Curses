...
public class ResonatingShot extends Enchantment {
    ...
    protected boolean canAccept(Enchantment other) {
        return !(other instanceof ElectrifyingShot) && other != Enchantments.QUICK_CHARGE && other != Enchantments.PIERCING && other != Enchantments.MULTISHOT && !(other instanceof HotShot);
    }
